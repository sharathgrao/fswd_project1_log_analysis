# Logs Analysis Project - Udacity Nano Degree - Full stack webdeveloper
...
# For Question 2 and Question 3 views present in Views.txt or Readme file.
...
# Present as a sorted list with the most popular author at the top.
